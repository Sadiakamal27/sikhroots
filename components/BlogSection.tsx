        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {blogs.map((blog, index) => (
            <motion.div
              ...
              className="group bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl overflow-hidden p-4 md:p-6 shadow-sm hover:shadow-xl transition-all duration-500"
            >
